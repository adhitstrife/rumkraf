      ...
      <div className="content flex flex-col md:flex-row-reverse static h-auto md:min-h-screen md: w-full py-4 px-4 sm:px-8 lg:px-16 xl:px-32 overflow-hidden">
        ...
        <div className="top relative md:w-1/2 h-108 md:h-80 lg:ml-8">
          ...
          <div className="building relative flex flex-col items-center w-full z-10">
            <motion.div initial={{ opacity: 0, y: 100 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 1.5 }} className="building-4 absolute mt-64">
              <Image height="300" width="300" src='image/building_4.svg' alt='building4' />
            </motion.div>
            <motion.div initial={{ opacity: 0, y: 100 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 1 }} className="building-3 absolute mt-40">
              <Image height="300" width="300" src='image/building_3.svg' alt='building3' />
            </motion.div>
            <motion.div initial={{ opacity: 0, y: 100 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.5 }} className="building-2 absolute mt-16">
              <Image height="300" width="300" src='image/building_2.svg' alt='building2' />
            </motion.div>
            <motion.div initial={{ opacity: 0, y: 100 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="building-1 absolute ml-6 mt-0">
              <Image height="300" width="280" src='image/building_1.svg' alt='building1' />
            </motion.div>
          </div>
